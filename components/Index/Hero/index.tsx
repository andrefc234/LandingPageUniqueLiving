...
export default function index() {
  return (
    ...
    <Container className='my-5'>
        <Row className='my-5' ><h1 style={{fontFamily:'Montserrat', fontWeight:'bold' fontSize:'2.5rem'}}>Unique Living Querétaro</h1><h2 style={{fontFamily:'Montserrat'}}>Arquitectos con mas de 10 años de experiencia</h2></Row>
