...
export default function index() {
  return (
    ...
    <Container className='my-5'>
        <Row className='my-5' ><h1 style={{fontFamily:'Montserrat', fontWeight:'bold'}}>Unique Living Querétaro</h1><h2 style={{fontFamily:'Montserrat'}}>Arquitectos con años de experiencia</h2></Row>
